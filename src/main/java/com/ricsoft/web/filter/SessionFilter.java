...
package com.ricsoft.web.filter;

import com.ricsoft.managebeans.LoginManagedBean;
...
public class SessionFilter implements Filter {
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
        ...
        loginmanagedbean = (LoginManagedBean) req.getSession().getAttribute("loginManagedBean");
        
        String urlStr  = req.getRequestURL().toString().toLowerCase();
        //Si no requiere protección continúo normalmente.
        if (urlStr.endsWith("index.faces")) {
            loginmanagedbean.getLoginbean().setBoollogueado(false);
            return;
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (loginmanagedbean == null || !loginmanagedbean.getLoginbean().isBoollogueado()) {
